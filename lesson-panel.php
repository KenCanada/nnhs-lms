                            ...
                            <table class="table table-striped text-center">
                                ...
                                <?php
                                    $retrieveLessons = "SELECT *
                                                        ...
                                                        WHERE subjectid_file = '$subjectidFromURL'
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped text-center">
                                ...
                                <?php
                                    $retrieveLessons = "SELECT *
                                                        FROM tbl_lesson_url
                                                        WHERE subjectid_url = '$subjectidFromURL'
                                                        ORDER BY datetimestamp DESC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-right"><a href="<?php echo $url; ?>" class="btn btn-primary mr-3" style="width:40px;" target="_blank" data-toggle="tooltip" data-placement="top" title="VIEW"><i class="fas fa-external-link-alt"></i></a><a href="" class="btn btn-warning mr-3" style="width:40px;"><i class="far fa-edit"></i></a><a href="" class="btn btn-danger mr-3" style="width:40px;"><i class="far fa-trash-alt"></i></a></td>
                                    </tr>
                                <?php } ?>
                            </table>
                        </div>
