                    ...
                    <a href="manage-blotter.php">
                        <div class="card text-center mb-3 card-table" style="width: 100%;">
                            ...
                            <div class="card-body count-blotter">
                                <p class="card-text count-lbl"><i class="far fa-user"></i>&nbsp;&nbsp;5</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md-4">
                    <a href="manage-blotter.php">
                        <div class="card text-center mb-3 card-table" style="width: 100%;">
                            ...
                            <div class="card-body count-blotter">
                                <p class="card-text count-lbl"><i class="far fa-copy"></i>&nbsp;&nbsp;5</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md-4">
                    <a href="manage-blotter.php">
                        <div class="card text-center mb-3 card-table" style="width: 100%;">
                            ...
                            <div class="card-body count-blotter">
                                <p class="card-text count-lbl"><i class="far fa-folder"></i></i>&nbsp;&nbsp;5</p>
                            </div>
                        </div>
                    </a>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped text-center">
                                            ...
                                            <?php
                                                $retrieveExam = "SELECT * FROM tbl_exam_session 
                                                                 WHERE subjectid = '$subjectidFromURL'
                                                                 AND archive_exam = '0'
                                                                 ORDER BY date_start ASC LIMIT 5";

                                                $resultExam = mysqli_query($conn, $retrieveExam);

                                                while($DataRows = mysqli_fetch_assoc($resultExam)){
                                                    $exam_title = $DataRows['exam_title'];
                                                    $date_start = $DataRows['date_start'];
                                            ?>
                                                <tr>
                                                    <td><?php echo htmlentities($exam_title); ?></td>
                                                    <td><?php echo htmlentities($date_start); ?></td>
                                                </tr>
                                            <?php } ?>
                                        </table>
                                    </div>
                            ...
                            <div class="card-header card-table-header">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <?php
                                            $retrieveAssignment = "SELECT * FROM tbl_assignment 
                                                             WHERE subjectid_assign = '$subjectidFromURL'
                                                             AND archivestatus_assign = '0'
                                                             ORDER BY deadline_assign ASC LIMIT 5";

                                            $resultAssignment = mysqli_query($conn, $retrieveAssignment);

                                            while($DataRows = mysqli_fetch_assoc($resultAssignment)){
                                                $aasign_name = $DataRows['assign_name'];
                                                $deadline_assign = $DataRows['deadline_assign'];
                                        ?>
                                            <tr>
                                                <td><?php echo htmlentities($aasign_name); ?></td>
                                                <td><?php echo htmlentities($deadline_assign); ?></td>
                                            </tr>
                                        <?php } ?>
                                        </table>
                                    </div>
