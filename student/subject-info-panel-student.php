...
<body>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="view-assignment.php?id=<?php echo $subjectidFromURL; ?>">Add Assignment</a>
    ...
    <section id="subject-info-panel">
        ...
        <?php echo errorMessage(); echo successMessage(); ?>
            <div class="row mb-3">
                <div class="col">
                    <h1 class="subject-name-heading"><?php echo $subjectname; ?>&nbsp;&nbsp;<a href="view-updates.php?id=<?php echo $subjectidFromURL; ?>" class="btn btn-primary btn-updates"><i class="far fa-sticky-note"></i>&nbsp;&nbsp;View Updates</a></h1>
                </div>
            </div>
    </section>
