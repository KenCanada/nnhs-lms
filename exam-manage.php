                                ...
                                <table class="table table-striped text-center">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-right"><a href="view-exam.php?id=<?php echo $subjectidFromURL ?>&amp;eID=<?php echo $exam_session_id; ?>" class="btn btn-primary mr-3" style="width:40px;" target="_blank" data-toggle="tooltip" data-placement="top" title="VIEW"><i class="fas fa-external-link-alt"></i></a><a href="" class="btn btn-warning mr-3" style="width:40px;"><i class="far fa-edit"></i></a><a href="" class="btn btn-danger mr-3" style="width:40px;"><i class="far fa-trash-alt"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                </table>
                            </div>       
